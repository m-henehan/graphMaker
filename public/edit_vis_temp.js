...
function editGraph(...params){
	...
	for(let i=0; i<causes.length; i++){
		document.getElementById("causesList"+j).innerHTML += "<br><h4>Cause "+(i+1)+": 	<button type='button' class='btn btn-primary' data-toggle='modal' onclick =question('"+causes[i]+"') data-target='#editModal'>"+causes[i]+"</button></h4>";
		for(let k=0; k<parents.length; k++){
			if (parents[k] == (i+1)){
				document.getElementById("causesList"+j).innerHTML += "<h4>	SubCause:	<button type='button' class='btn btn-primary' data-toggle='modal' onclick =question('"+subcauses[k]+"') data-target='#editModal'>"+subcauses[k]+"</button></h4>";
			}
		}
	}
	...
	document.getElementById("causesList"+j).innerHTML += "<h4>Effect: <button type='button' class='btn btn-primary' data-toggle='modal' onclick =question('"+effect+"') data-target='#editModal'>"+effect+"</button></h4>";
...
function changeField(){
	...
	document.getElementById("element").value="whatever you want here";
